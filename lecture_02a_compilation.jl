...
md"""
# Notes on Julia's execution and compilation
"""
...
# ╔═╡ 1eea715e-7bb0-492f-a271-ed51a67b843d
play(Scissors, Scissors)

# ╔═╡ 1eba82ec-eb66-42dd-8541-00a70b5a51fd
@which play(Rock, Scissors)

# ╔═╡ 1fe6454a-af62-4173-a1a6-29f31b29d24e
@which play(Rock, Scissors)

# ╔═╡ 42486257-d59c-4bd9-ab1a-bae2f8c991df


# ╔═╡ a067980f-2bec-4e9f-adc1-bf9d0f2ab01f
md"""
...
# ╔═╡ 4fa05e60-aa97-440f-9a78-ff025e707214
md"""
...
# ╔═╡ 9a6c9ebe-d6a5-4267-a25a-531344e4202e
Meta.@dump 1.0 + 2.0

# ╔═╡ b6474ef6-b7b2-43e0-b4cb-23192f321170
@code_typed optimize = false 1.0 + 2.0

# ╔═╡ e4a3b79c-2f3d-4d27-a91a-056f462bc424
with_terminal() do
	@code_llvm debuginfo=:none 1.0 + 2.0
end

# ╔═╡ f2af208e-dfec-4c97-833b-aec5adea0206
with_terminal() do
